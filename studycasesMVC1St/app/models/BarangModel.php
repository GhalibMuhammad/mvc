...
class BarangModel
{
  ...
  public function tambahBarang($data)
  {
    ...
    $this->db->execute();  // mengeksekusi query
  ...
  public function updateBarang($data)
  {
    ...
    if ($data['tgl_kembali'] != $tglKembaliDatabase) {
      ...
      $query = "UPDATE tb_pinjam SET nama_peminjam=:nama_peminjam, jenis_barang=:jenis_barang, no_barang=:no_barang, tgl_pinjam=:tgl_pinjam, tgl_kembali=:tgl_kembali, status='sudah kembali' WHERE id=:id";
    } else {
  ...
  public function cariBarang($barang)
  {
    ...
    return $this->db->resultSet(); // Metode ini digunakan untuk mengembalikan hasil dari query SQL dalam bentuk array multi dimensi
  }
}
